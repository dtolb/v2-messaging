...
| to            | `array` of `strings` | The phone numbers the message should be sent to (must be in E.164 format, like `+19195551212`). <br><br> Example: <br> `["+19195551212", "+19195554444", "+19192227777"]` <br><br>Maximum of 10 participants in a Group Message | Yes       |
