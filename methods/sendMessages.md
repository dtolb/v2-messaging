...
** Notice: This URL will be deprecated in June 2019. This URL is being replaced by `https://messaging.bandwidth.com/api/v2`, which will be active in April 2019. Current customers will be notified when the new URL is ready to be used, and should not switch until notified.**
