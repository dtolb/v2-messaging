...
| `accountId`                            | Your unique account **id**.  The `accountId` is used as part of the url to make API requests. <br> Ex: `https://dashboard.bandwidth.com/api/accounts/{accountId}/` or `https://messaging.bandwidth.com/api/v2/users/{accountId}/messages`                                                                                                                    |  `920012`                             |
