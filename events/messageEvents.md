...
* Callbacks will be sent to the Callback URL for the [Application](../applications/about.md) associated with the `applicationId` field sent with the [send message](../methods/sendMessages) payload
